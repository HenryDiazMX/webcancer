...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cancerinfantil', '0003_delete_republica'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitud_resid', models.TextField(blank=True, db_column='LATITUD_RESID', null=True)),
                ...
                ('latitud_ocurr', models.TextField(blank=True, db_column='LATITUD_OCURR', null=True)),
