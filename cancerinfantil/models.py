...
class guerrero(models.Model):
    ...
    coincidencia_resid = models.TextField(db_column='COINCIDENCIA_RESID', blank=True,
    ...
    coincidencia_ocurr = models.TextField(db_column='COINCIDENCIA_OCURR', blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    dia_ocurr = models.BigIntegerField(db_column='DIA_OCURR', blank=True, null=True)  # Field name made lowercase.
    ...
    dia_nacim = models.BigIntegerField(db_column='DIA_NACIM', blank=True, null=True)  # Field name made lowercase.
    mes_nacim = models.TextField(db_column='MES_NACIM', blank=True, null=True)  # Field name made lowercase.
    anio_nacim = models.BigIntegerField(db_column='ANIO_NACIM', blank=True, null=True)  # Field name made lowercase.
    ...
    fecha_verificacion = models.TextField(db_column='FECHA_VERIFICACION', blank=True,
                                          null=True)  # Field name made lowercase.
    nombre_verificador = models.TextField(db_column='NOMBRE_VERIFICADOR', blank=True,
                                          null=True)  # Field name made lowercase.
    edad_abs = models.TextField(db_column='EDAD_ABS', blank=True, null=True)  # Field name made lowercase.
    coordenadas_resid = models.TextField(db_column='COORDENADAS_RESID', blank=True,
                                         null=True)  # Field name made lowercase. This field type is a guess.
    coordenadas_ocurr = models.TextField(db_column='COORDENADAS_OCURR', blank=True,
                                         null=True)  # Field name made lowercase. This field type is a guess.
...
class republica(models.Model):
    ...
    tloc_resid = models.TextField(db_column='TLOC_RESID', blank=True, null=True)  # Field name made lowercase.
    loc_resid = models.TextField(db_column='LOC_RESID', blank=True, null=True)  # Field name made lowercase.
    latitud_resid = models.TextField(db_column='LATITUD_RESID', blank=True, null=True)  # Field name made lowercase.
    longitud_resid = models.TextField(db_column='LONGITUD_RESID', blank=True, null=True)  # Field name made lowercase.
    coincidencia_resid = models.TextField(db_column='COINCIDENCIA_RESID', blank=True, null=True)  # Field name made lowercase.
    ent_ocurr = models.TextField(db_column='ENT_OCURR', blank=True, null=True)  # Field name made lowercase.
    mun_ocurr = models.TextField(db_column='MUN_OCURR', blank=True, null=True)  # Field name made lowercase.
    tloc_ocurr = models.TextField(db_column='TLOC_OCURR', blank=True, null=True)  # Field name made lowercase.
    loc_ocurr = models.TextField(db_column='LOC_OCURR', blank=True, null=True)  # Field name made lowercase.
    latitud_ocurr = models.TextField(db_column='LATITUD_OCURR', blank=True, null=True)  # Field name made lowercase.
    longitud_ocurr = models.TextField(db_column='LONGITUD_OCURR', blank=True, null=True)  # Field name made lowercase.
